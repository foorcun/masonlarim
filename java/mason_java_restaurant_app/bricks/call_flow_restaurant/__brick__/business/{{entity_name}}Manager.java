...
public class {{entity_name.pascalCase()}}Manager implements  I{{entity_name.pascalCase()}}Service{
    ...
    @Override
    public String delete{{entity_name.pascalCase()}}(String id) throws ExecutionException, InterruptedException{
        return {{entity_name.camelCase()}}Dal.delete{{entity_name.pascalCase()}}(id);
    }
