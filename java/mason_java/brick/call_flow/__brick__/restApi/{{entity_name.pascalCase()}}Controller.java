...
public List<{{entity_name.pascalCase()}}> getAll{{entity_name.pascalCase()}}() throws InterruptedException, ExecutionException {
    ...
    public {{entity_name.pascalCase()}} getById(@RequestParam String documentId)throws InterruptedException, ExecutionException{
        return {{entity_name.camelCase()}}Manager.getById(documentId);
    }
    ...
    public String delete{{entity_name.pascalCase()}}(@RequestParam String documentId){
        return {{entity_name.camelCase()}}Manager.delete{{entity_name.pascalCase()}}(documentId);
    }
